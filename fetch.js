...
>>>>>>> Stashed changes
    ...
    data = await fetch("http://libauto.mingdao.edu.tw/AACourses/Web/wLogin.php", {
        ...
        var status = Object.getOwnPropertySymbols(response).map(item => response[item])[1].status;
        ...
        if (cookie == "network error 1") {
            ...
            var data = await fetch("http://libauto.mingdao.edu.tw/AACourses/Web/wLogin.php", {
                "headers": {
                    "accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
                    "accept-language": "zh-TW,zh;q=0.9",
